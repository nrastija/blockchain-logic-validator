...
#mode save
#mode nocomment "%"
#define FLORA_THIS_FILENAME  'foo.ergo'
#mode restore
/************************************************************************
...
#mode save
#mode nocomment "%"
#define FLORA_FDB_FILENAME  'foo.fdb'
#mode restore
...
#mode save
#mode nocomment "%"
#define FLORA_FLD_FILENAME  'foo.fld'
#mode restore
...
#mode save
#mode nocomment "%"
#define FLORA_FLS_FILENAME  'foo.fls'
#mode restore
...
#mode save
#mode nocomment "%"
#define FLORA_FLS2_FILENAME  'foo.fls2'
#mode restore
...
?-(:(flrutils,util_load_structdb('foo.ergo',FLORA_THIS_MODULE_NAME))).
